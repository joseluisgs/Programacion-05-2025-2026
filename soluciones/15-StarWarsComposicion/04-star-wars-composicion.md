## 💥 Star Wars: Misión en Prog-JL por Composición, El Desafío del Sith Lord JoseLuisGS
...
#### C. Cambio Dinámico de Tipo de Droide 🔄
**Ha surgido un problema de última hora**: Debido a la resistencia de la república, nos vemos obligo a adaptar los driodes y que puedan cambiar sus características en medio de la batalla. Es decir, que un droide pueda cambiar su tipo a otro diferente (por ejemplo, de SW348 a SW421) para adaptarse mejor al combate.

* **Cambio de Tipo de Droide:** Cada **300 milisegundos**, cada droide tiene un **50%** de probabilidad de cambiar su tipo a uno diferente si sobrevive al ataque (seleccionado aleatoriamente entre los otros tres tipos disponibles). Al cambiar de tipo, el droide debe actualizar sus características (Energía Máxima, Defensa, Velocidad, etc.) según el nuevo tipo.

#### D. Movimiento de la Horda 🔄

  * **Frecuencia:** Cada **100 milisegundos**, todos los droides activos cambian de posición a una nueva coordenada aleatoria válida dentro de la cuadrícula.

#### E. Destrucción de la Unidad 💀
